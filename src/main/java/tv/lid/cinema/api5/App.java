...
import tv.lid.cinema.api5.config.Config;
import tv.lid.cinema.api5.controllers.MovieController;
import tv.lid.cinema.api5.controllers.ScheduleController;
import tv.lid.cinema.api5.models.CommonModel;
import tv.lid.cinema.api5.models.MovieModel;
import tv.lid.cinema.api5.models.ScheduleModel;
import tv.lid.cinema.api5.storages.DatabaseStorage;

@OpenAPIDefinition(
    info = @Info(
        title = "Cinema REST API",
        description = "Демонстрационный пример REST API для кинотеатра, написанный на Java",
        termsOfService = "https://github.com/masterlid/rest-java-api-5",
        contact = @Contact(
            name  = "Master Lid",
            url   = "http://lid.tv",
            email = "master@lid.tv"
